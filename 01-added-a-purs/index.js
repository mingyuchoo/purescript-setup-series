...
(function($PS) {
  ...
  var main = function __do() {
      Effect_Console.log("\ud83c\udf5d")();
      Effect_Console.log(Data_Show.show(Data_Show.showNumber)(Shapes.area(new Shapes.Circle({
          x: 0.0,
          y: 0.0
      }, 5.3))))();
      return Effect_Console.log("The answer is " + Data_Show.show(Data_Show.showInt)(Euler.answer))();
  };
  exports["main"] = main;
})(PS);
PS["Main"].main();